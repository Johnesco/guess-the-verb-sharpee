 ...
 */
export declare function captureEntitySnapshot(entity: IFEntity, world: WorldModel, includeContents?: boolean): EntitySnapshot;
/**
 ...
 */
export declare function captureRoomSnapshot(room: IFEntity, world: WorldModel, includeContents?: boolean): RoomSnapshot;
/**
 ...
 */
export declare function captureEntitySnapshots(entities: IFEntity[], world: WorldModel): EntitySnapshot[];
/**
 ...
 */
export declare function createEntityReference(entity: IFEntity): {
    id: string;
    name: string;
};
/**
 ...
 */
export declare function createEntityReferences(entities: IFEntity[]): {
    id: string;
    name: string;
}[];
