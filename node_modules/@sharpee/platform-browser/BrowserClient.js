...
const DialogManager_1 = require("./managers/DialogManager");
const MenuManager_1 = require("./managers/MenuManager");
const InputManager_1 = require("./managers/InputManager");
const TextDisplay_1 = require("./display/TextDisplay");
const StatusLine_1 = require("./display/StatusLine");
...
class BrowserClient {
    constructor(config) {
        ...
        this.currentTurn = 0;
        this.currentScore = 0;
        this.turnOffset = 0; // Offset to add to engine turn after restore
        this.config = {
            autoSave: true,
            ...config,
        };
    ...
    setupEngineHandlers() {
        ...
        this.engine.on('text:output', (blocks, turn) => {
            ...
            const text = (0, text_service_1.renderToString)(displayBlocks);
        ...
        this.engine.on('event', (event) => {
            ...
            if (event.type.startsWith('audio.')) {
                this.audioManager.handleAudioEvent(event);
                return;
            }
    ...
    async start() {
        ...
        try {
            ...
            if (this.world) {
                ...
                const trait = storyInfoEntities[0]?.get(world_model_1.TraitType.STORY_INFO);
                if (trait) {
